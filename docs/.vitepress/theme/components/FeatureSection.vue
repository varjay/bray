...
const features = [
  ...
  },
  {
    ...
    title: '控制阀',
    content: '我们久经验证的控制阀组件设计用于精密控制，并通过严格检测以在任何工艺条件下提供始终如一的性能。博雷控制阀解决方案拥有全球范围内的信誉度，有助于在提高生产率和盈利能力的同时降低综合成本。'
  },
  {
    ...
    <div class="mt-3 py-10">
      <div class="container mx-auto">
        ...
        <div class="text-center mt-8">
          <a href="/contact-us" class="btn inline-block">了解更多</a>
        </div>
      </div>
    </div>
  </div>
...
@media (max-width: 768px) {
  ...
  .feature-section-cards .feature-card {
    width: 100%;
  }
}
</style>